...
class ExcelProcessor:
    ...
    def process_file(self, file_path_list, output_directory):
        tipos_de_piezas = [
            'ADAP BAT','ASS','BATERIA','BOCINA',
            'BOTON ','CAMARA','CARG INALAM','CD',
            'CD MAGNETICO','COV','FALLO','FLEX',
            'GEVEY',
            'MC','MC (CAMARA)','MEM USB','MHG','MICRO SD',
            'MICROFONO','ML BT','ML CABLE','MODULO DE CARGA',
            'NOMINA','OTROS ','PC MICRO','PC TIPO C',
            'POWER BANK','PTA CR 3A USB',
            'PTA CR 1HORA USB','PTA 2A TIPO C','PTA (OTRA)',
            'TAPA TRASERTA ANDROID','TAPA TRASERA IPHONE',
            'TARJETA INT','TELEF','TIP','TOMAR ENCARGO','VIAJE']
