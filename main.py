...
def obtener_archivos_xlsx_en_directorio_actual():
  ...
  archivos_xlsx = [archivo for archivo in os.listdir(directorio_actual) if archivo.endswith('.xlsx') and not archivo.startswith('~') and not archivo.startswith('RESUMEN_')]
